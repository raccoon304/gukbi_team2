        ...
        <form id="productForm">
            ...
            <div class="form-section">
                ...
                <div class="input-group input-group-lg">
                    <input type="text" class="form-control" id="productCode" name="productCode" placeholder="상품 코드를 입력하세요 (예: Ap001, Ga001)" maxlength="10" required>
                    <div class="input-group-append">
                        <button class="btn btn-outline-primary" type="button" id="checkDuplicateBtn">
                            <i class="fas fa-check-circle mr-2"></i>중복 확인
                        </button>
                    </div>
                </div>
                <small class="form-text text-muted">영문 2자리 + 숫자 조합으로 입력하세요</small>
            ...
            <div class="form-section">
                ...
                <input type="text" class="form-control form-control-lg" id="productName" name="productName" placeholder="상품명을 입력하세요 (예: 아이폰 17 Pro Max)" required>
            </div>
            ...
            <div class="form-section">
                ...
                <small class="form-text text-muted">256GB의 기본 판매 가격입니다</small>
            </div>
