...
-- status Ïª¨Îüº ?îî?è¥?ä∏Í∞? ?Ñ§?†ï
ALTER TABLE TBL_MEMBER
  MODIFY (STATUS DEFAULT 0);
  
-- idle Ïª¨Îüº ?îî?è¥?ä∏Í∞? ?Ñ§?†ï
ALTER TABLE TBL_MEMBER
...
-- userseq Ïª¨Îüº ?ú†?ãà?Å¨?†ú?ïΩ ?Ñ§?†ï
alter table tbl_member
add constraint UQ_TBL_MEMBER_USERSEQ unique(userseq);

-- userseq Ïª¨Îüº not null ?Ñ§?†ï
alter table tbl_member
...
-- IMAGE_PATH Ïª¨Îüº Ï∂îÍ?
ALTER TABLE TBL_PRODUCT
ADD (IMAGE_PATH VARCHAR2(200));

-- IMAGE_PATH Ïª¨Îüº NOT NULL ?†ú?ïΩ
ALTER TABLE TBL_PRODUCT
...
------ ?ÉÅ?íà?Öå?ù¥Î∏? ?†ïÎ≥? Ï∂úÎ†•?ïòÍ∏?
select *
from tbl_product
order by product_name;

------ ?ÉÅ?íà?ÉÅ?Ñ∏?Öå?ù¥Î∏? ?†ïÎ≥? Ï∂úÎ†•?ïòÍ∏?
select * from tbl_product_option;
...
values('1000AP', 'iPhone17', 'Apple', '?ïÑ?ù¥?è∞17?óê ???ïú ?Ñ§Î™ÖÏûÖ?ãà?ã§. ?ûÑ?ãú ?Ñ§Î™ÖÏûÖ?ãà?ã§. ?ÇòÏ§ëÏóê updateÎ°? Î∞îÍæ∏?Ñ∏?öî.', '?åêÎß§Ï§ë', 'test.jpg');
insert into tbl_product
values('1100AP', 'iPhone17 Pro', 'Apple', '?ïÑ?ù¥?è∞17 Pro?óê ???ïú ?Ñ§Î™ÖÏûÖ?ãà?ã§. ?ûÑ?ãú ?Ñ§Î™ÖÏûÖ?ãà?ã§. ?ÇòÏ§ëÏóê updateÎ°? Î∞îÍæ∏?Ñ∏?öî.', '?åêÎß§Ï§ë', 'test.jpg');
insert into tbl_product
values('1200AP', 'iPhone17 Pro Max', 'Apple', '?ïÑ?ù¥?è∞17 Pro Max?óê ???ïú ?Ñ§Î™ÖÏûÖ?ãà?ã§. ?ûÑ?ãú ?Ñ§Î™ÖÏûÖ?ãà?ã§. ?ÇòÏ§ëÏóê updateÎ°? Î∞îÍæ∏?Ñ∏?öî.', '?åêÎß§Ï§ë', 'test.jpg');

-- ?ïÑ?ù¥?è∞16 ?ç∞?ù¥?Ñ∞Í∞?
insert into tbl_product
values('2000AP', 'iPhone16', 'Apple', '?ïÑ?ù¥?è∞16?óê ???ïú ?Ñ§Î™ÖÏûÖ?ãà?ã§. ?ûÑ?ãú ?Ñ§Î™ÖÏûÖ?ãà?ã§. ?ÇòÏ§ëÏóê updateÎ°? Î∞îÍæ∏?Ñ∏?öî.', '?åêÎß§Ï§ë', 'test.jpg');
insert into tbl_product
values('2100AP', 'iPhone16 Pro', 'Apple', '?ïÑ?ù¥?è∞16 Pro?óê ???ïú ?Ñ§Î™ÖÏûÖ?ãà?ã§. ?ûÑ?ãú ?Ñ§Î™ÖÏûÖ?ãà?ã§. ?ÇòÏ§ëÏóê updateÎ°? Î∞îÍæ∏?Ñ∏?öî.', '?åêÎß§Ï§ë', 'test.jpg');
insert into tbl_product
values('2200AP', 'iPhone16 Pro Max', 'Apple', '?ïÑ?ù¥?è∞16 Pro Max?óê ???ïú ?Ñ§Î™ÖÏûÖ?ãà?ã§. ?ûÑ?ãú ?Ñ§Î™ÖÏûÖ?ãà?ã§. ?ÇòÏ§ëÏóê updateÎ°? Î∞îÍæ∏?Ñ∏?öî.', '?åêÎß§Ï§ë', 'test.jpg');
commit;

-- ?ïÑ?ù¥?è∞15 ?ç∞?ù¥?Ñ∞Í∞?
insert into tbl_product
values('3000AP', 'iPhone15', 'Apple', '?ïÑ?ù¥?è∞15?óê ???ïú ?Ñ§Î™ÖÏûÖ?ãà?ã§. ?ûÑ?ãú ?Ñ§Î™ÖÏûÖ?ãà?ã§. ?ÇòÏ§ëÏóê updateÎ°? Î∞îÍæ∏?Ñ∏?öî.', '?åêÎß§Ï§ë', 'test.jpg');
insert into tbl_product
values('3100AP', 'iPhone15 Pro', 'Apple', '?ïÑ?ù¥?è∞15 Pro?óê ???ïú ?Ñ§Î™ÖÏûÖ?ãà?ã§. ?ûÑ?ãú ?Ñ§Î™ÖÏûÖ?ãà?ã§. ?ÇòÏ§ëÏóê updateÎ°? Î∞îÍæ∏?Ñ∏?öî.', '?åêÎß§Ï§ë', 'test.jpg');
insert into tbl_product
values('3200AP', 'iPhone15 Pro Max', 'Apple', '?ïÑ?ù¥?è∞15 Pro Max?óê ???ïú ?Ñ§Î™ÖÏûÖ?ãà?ã§. ?ûÑ?ãú ?Ñ§Î™ÖÏûÖ?ãà?ã§. ?ÇòÏ§ëÏóê updateÎ°? Î∞îÍæ∏?Ñ∏?öî.', '?åêÎß§Ï§ë', 'test.jpg');
commit;

-------------------------------------------------------------------------------------------------------------------------------------------------
-- Í∞§Îü≠?ãú?è∞ ?ç∞?ù¥?Ñ∞Í∞?
insert into tbl_product
values('1000GX', 'Galaxy Z Fold7', 'Galaxy', 'Í∞§Îü≠?ãú Z?è¥?ìú7?óê ???ïú ?Ñ§Î™ÖÏûÖ?ãà?ã§. ?ûÑ?ãú ?Ñ§Î™ÖÏûÖ?ãà?ã§. ?ÇòÏ§ëÏóê updateÎ°? Î∞îÍæ∏?Ñ∏?öî.', '?åêÎß§Ï§ë', 'test.jpg');
insert into tbl_product
values('1100GX', 'Galaxy Z Flip7', 'Galaxy', 'Í∞§Îü≠?ãú Z?îåÎ¶?7?óê ???ïú ?Ñ§Î™ÖÏûÖ?ãà?ã§. ?ûÑ?ãú ?Ñ§Î™ÖÏûÖ?ãà?ã§. ?ÇòÏ§ëÏóê updateÎ°? Î∞îÍæ∏?Ñ∏?öî.', '?åêÎß§Ï§ë', 'test.jpg');
insert into tbl_product
values('1200GX', 'Galaxy S25 Ultra', 'Galaxy', 'Í∞§Îü≠?ãú s25 ?ö∏?ä∏?ùº?óê ???ïú ?Ñ§Î™ÖÏûÖ?ãà?ã§. ?ûÑ?ãú ?Ñ§Î™ÖÏûÖ?ãà?ã§. ?ÇòÏ§ëÏóê updateÎ°? Î∞îÍæ∏?Ñ∏?öî.', '?åêÎß§Ï§ë', 'test.jpg');
commit;

---------------- Í∞§Îü≠?ãú6, 24
insert into tbl_product
values('2000GX', 'Galaxy Z Fold6', 'Galaxy', 'Í∞§Îü≠?ãú Z?è¥?ìú6?óê ???ïú ?Ñ§Î™ÖÏûÖ?ãà?ã§. ?ûÑ?ãú ?Ñ§Î™ÖÏûÖ?ãà?ã§. ?ÇòÏ§ëÏóê updateÎ°? Î∞îÍæ∏?Ñ∏?öî.', '?åêÎß§Ï§ë', 'test.jpg');
insert into tbl_product
values('2100GX', 'Galaxy Z Flip6', 'Galaxy', 'Í∞§Îü≠?ãú Z?îåÎ¶?6?óê ???ïú ?Ñ§Î™ÖÏûÖ?ãà?ã§. ?ûÑ?ãú ?Ñ§Î™ÖÏûÖ?ãà?ã§. ?ÇòÏ§ëÏóê updateÎ°? Î∞îÍæ∏?Ñ∏?öî.', '?åêÎß§Ï§ë', 'test.jpg');
insert into tbl_product
values('2200GX', 'Galaxy S24 Ultra', 'Galaxy', 'Í∞§Îü≠?ãú s24 ?ö∏?ä∏?ùº?óê ???ïú ?Ñ§Î™ÖÏûÖ?ãà?ã§. ?ûÑ?ãú ?Ñ§Î™ÖÏûÖ?ãà?ã§. ?ÇòÏ§ëÏóê updateÎ°? Î∞îÍæ∏?Ñ∏?öî.', '?åêÎß§Ï§ë', 'test.jpg');
commit;

---------------- Í∞§Îü≠?ãú5, 23
insert into tbl_product
values('3000GX', 'Galaxy Z Fold5', 'Galaxy', 'Í∞§Îü≠?ãú Z?è¥?ìú5?óê ???ïú ?Ñ§Î™ÖÏûÖ?ãà?ã§. ?ûÑ?ãú ?Ñ§Î™ÖÏûÖ?ãà?ã§. ?ÇòÏ§ëÏóê updateÎ°? Î∞îÍæ∏?Ñ∏?öî.', '?åêÎß§Ï§ë', 'test.jpg');
insert into tbl_product
values('3100GX', 'Galaxy Z Flip5', 'Galaxy', 'Í∞§Îü≠?ãú Z?îåÎ¶?5?óê ???ïú ?Ñ§Î™ÖÏûÖ?ãà?ã§. ?ûÑ?ãú ?Ñ§Î™ÖÏûÖ?ãà?ã§. ?ÇòÏ§ëÏóê updateÎ°? Î∞îÍæ∏?Ñ∏?öî.', '?åêÎß§Ï§ë', 'test.jpg');
insert into tbl_product
values('3200GX', 'Galaxy S23 Ultra', 'Galaxy', 'Í∞§Îü≠?ãú s23 ?ö∏?ä∏?ùº?óê ???ïú ?Ñ§Î™ÖÏûÖ?ãà?ã§. ?ûÑ?ãú ?Ñ§Î™ÖÏûÖ?ãà?ã§. ?ÇòÏ§ëÏóê updateÎ°? Î∞îÍæ∏?Ñ∏?öî.', '?åêÎß§Ï§ë', 'test.jpg');
commit;
...
-- ?ÉÅ?íà?ÉÅ?Ñ∏ ?†ïÎ≥¥Ï? ?ÉÅ?íàÎ™? Ï°∞Ïù∏?ïò?ó¨ Í∞ôÏù¥ Ï∂úÎ†•?ïòÍ∏?
SELECT P.product_code, option_id, P.product_name, color, storage_size, price, stock_qty
FROM tbl_product_option O
JOIN tbl_product P
ON P.product_code = O.fk_product_code
...
---------------------------------------Í∞§Îü≠?ãú ?ÉÅ?Ñ∏?òµ?Öò ?ç∞?ù¥?Ñ∞ ?ÇΩ?ûÖ----------------------------------------------------
-- Galaxy Z Fold7 ?ÉÅ?Ñ∏?òµ?Öò
insert into tbl_product_option 
...
--?ÉÅ?íà?óê ???ïú ?†ïÎ≥¥Ï? Í∞?Í≤©Ïù¥ ?†ú?ùº ?ÇÆ?? ?òµ?Öò?ùò ?†ïÎ≥¥Î?? Ï°∞Ïù∏?ïò?ó¨ Ï∂úÎ†•
SELECT
    p.product_code,
    p.product_name,
    p.brand_name,
...
-- ?ÉÅ?íà?òµ?Öò?Öå?ù¥Î∏îÏùò ?†ú?ïΩÏ°∞Í±¥?ì§ ?ôï?ù∏?ïòÍ∏?
...
-- ?ÉÅ?íà?òµ?Öò?Öå?ù¥Î∏îÏùò Í∞?Í≤? Ï≤¥ÌÅ¨Ï°∞Í±¥ ?Ç≠?†ú
ALTER TABLE tbl_product_option DROP CONSTRAINT CK_TBL_PRODUCT_OPTION_PRICE;

-- ?ÉÅ?íà?òµ?Öò?Öå?ù¥Î∏îÏùò pric Ïª¨Îüº ?Ç≠?†ú
ALTER TABLE tbl_product_option
DROP COLUMN price;

-- ?ÉÅ?íà?òµ?Öò?Öå?ù¥Î∏îÏóê plus_price Ïª¨Îüº Ï∂îÍ?(?†ú?ïΩÏ°∞Í±¥ 0Í≥? Í∞ôÍ±∞?Çò ?Åº)
ALTER TABLE tbl_product_option
...
-- ?ÉÅ?íà?Öå?ù¥Î∏îÏùò ?†ú?ïΩÏ°∞Í±¥?ì§ ?ôï?ù∏?ïòÍ∏?
SELECT constraint_name,
       constraint_type,
       table_name,
       search_condition
...
-- ?ÉÅ?íà?Öå?ù¥Î∏îÏóê price Ïª¨Îüº Ï∂îÍ?(?†ú?ïΩÏ°∞Í±¥ 0Î≥¥Îã§ Ïª§Ïïº ?ï®)
ALTER TABLE tbl_product
ADD price NUMBER
...
-- ?ÉÅ?íà?Öå?ù¥Î∏îÏùò Í∞?Í≤©Ïª¨?üΩ?óê Í∞? ?óÖ?ç∞?ù¥?ä∏?ïòÍ∏?
...
-- ?ÉÅ?íà?òµ?Öò?Öå?ù¥Î∏îÏùò Ï∂îÍ?Í∏àÏï° Ïª¨Îüº?óê Í∞? ?óÖ?ç∞?ù¥?ä∏?ïòÍ∏?
...
--(?ÉÅ?íàÏΩîÎìú,?ÉÅ?íàÎ™?,Î∏åÎûú?ìúÎ™?,?ù¥ÎØ∏Ï?Í≤ΩÎ°ú,Í∞?Í≤?)
select product_code, product_name, brand_name, image_path, price, sale_status
from tbl_product
where sale_status='?åêÎß§Ï§ë';
...
select distinct fk_product_code, plus_price, storage_size
from tbl_product_option
order by fk_product_code desc;
--where storage_size = '512GB';

show user;

select * from tbl_cart;
insert into tbl_cart(cart_id, fk_member_id, fk_option_id, quantity)
values(seq_tbl_cart_cart_id.nextval, 'anth', 187, 10);
commit;
...
select P.product_code, option_id, P.product_name, stock_qty, price, plus_price
from tbl_product_option O
join tbl_product P
ON O.fk_product_code = P.product_code
WHERE option_id = 149;
...
-- ?û¨Í≥†Îüâ?ùÑ ?Ñ£?ñ¥Ï£ºÍ∏∞ ?úÑ?ïú SQL Íµ¨Î¨∏
select stock_qty
from tbl_product_option
...
select price, plus_price, product_name, brand_name
from tbl_product_option O
join tbl_product P
ON O.fk_product_code = P.product_code
where option_id = 200;
...
select * from tbl_cart
where fk_member_id = 'anth';
--AND fk_option_id = '156';


update tbl_cart set quantity = quantity + 3 
where fk_member_id = 'anth' AND fk_option_id = '156';
commit;

select * from tbl_product;


select product_code, option_id, product_name, storage_size, color, price, plus_price, stock_qty
      ,brand_name, product_desc
from tbl_product P
join tbl_product_option O
on P.product_code = O.fk_product_code
