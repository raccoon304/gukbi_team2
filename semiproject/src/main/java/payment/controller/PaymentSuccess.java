        ...
        if (couponIdParam != null && !couponIdParam.isBlank()) {
            try {
                ...
                if (couponIssueId > 0) {
                    ...
                    if (couponInfo == null) {
                        System.out.println("⚠️ 유효하지 않은 쿠폰");
                        couponIssueId = 0;
                    }
                }
        ...
        try {
            ...
            if (couponIssueId > 0) {
                ...
                if (couponResult > 0) {
                    ...
                    System.out.println("⚠️ 쿠폰 사용 처리 실패 (이미 사용됨?)");
                }
            }
            ...
            if (!cartIdsToDelete.isEmpty()) {
                ...
                System.out.println("ℹ️ 삭제할 장바구니 항목 없음 (바로구매)");
            }
        ...
        try {
            ...
            for (CartDTO cart : cartList) {
                ...
                if (result > 0) {
                    ...
                    totalFailed++;
                    System.out.println("⚠️ 재고 복구 실패: 옵션ID=" + cart.getOptionId());
                }
            }
        ...
        try {
            ...
            if (pgTid != null && !pgTid.isBlank()) {
                ...
                if (cancelSuccess) {
                    ...
                    System.out.println("⚠️⚠️⚠️ PG 결제 취소 실패 - 수동 환불 필요!");
